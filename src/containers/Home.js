...
export default function Home() { 
    ...
    return (
        <main id="Home" className="border-bottom"> 
            ...
            <Header postsSport={dummyPosts} postsBreakingNews={dummyPosts} isLoading={isLoading} />

            <Banner />

            <div className="container-fluid row mx-auto pt-3 border-bottom">

                <SectionOpinion posts={dummyPosts} isLoading={isLoading} />
                <SectionBusiness posts={dummyPosts} isLoading={isLoading} />
                <SectionSport posts={dummyPosts} isLoading={isLoading} />

            </div>

            <div className="container-fluid row mx-auto py-3 border-bottom">

                <SectionTravel posts={dummyPosts} isLoading={isLoading} />
                <SectionTravel posts={dummyPosts} isLoading={isLoading} />
                        ...
                        <div className="card">
                            ...
                            <a className="text-dark" href={`/filter/opinion`}>
                                ...
                                <div className="card-img-overlay">
                                    ...
                                    {/* Title */}
                                    <h3 className="moveForward my-2 bg-light py-2 px-5 border border-dark rounded">
                ...
                <div className="row">
                    <div className="col-sm-12">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            {/* Dummy Posts - Start */}
                            {
                                dummyPosts.slice(0,8).map((post, i) => {
                                    ...
                                    return (
                                        <li className="moveBackward list-group-item list-group-item-action  text-dark">
                                            ...
                                            <a className="text-dark" href={`/view/${postId}`}>
                                                ...
                                                <small className="text-secondary d-block"><i> 2/21/2021, 1:38:51 PM </i></small>
                                            </a>
                                    ...
                                    return (
                                        <li className="moveBackward list-group-item list-group-item-action text-dark" key={i++}>
                                            ...
                                            <a className="text-dark" href={`/view/${postId}`}>
                                                ...
                                                <small className="text-secondary d-block"> 2/21/2021, 1:38:51 PM </small>
                                            </a>
...
function Banner() {
    return (
        <div className="container-fluid row bg-dark shadow-sm text-white m-0">
            <div className="col-sm-12 h-100">
                <div className="row">

                    <div className="col-sm-4 text-center">
                        <h3 className="m-0 my-2"><b>Breaking News</b></h3>
                    </div>

                    <div className="col-sm-4 text-center">
                        <h3 className="m-0 my-2"><b>World News</b></h3> 
                    </div>

                    <div className="col-sm-4 text-center">
                        <h3 className="m-0 my-2"><b>Vacation News </b></h3>
                    </div>
                                ...
                                return (
                                    <li className="moveBackward list-group-item list-group-item-action  text-dark">
                                        ...
                                        <a className="text-dark" href={`/view/${postId}`}>
                                            ...
                                            <small className="text-secondary d-block">{published}</small>
                                        </a>
                                    </li>
                                );
                            })
