...
export default function PostNew() {
    ...
    return ( 
        <main id="PostNew" className="container-fluid border-top border-bottom pb-5 p-0"> 
            ...
            { /* Tabs - Start */}
            <div className="container mx-auto py-3 border-bottom">
                    ...
                    <ul className="list-group list-group-flush ">
                        ...
                        <li className="list-group-item px-0 bg-light pt-0">
                            <ul className="list-group list-group-horizontal">
                                <li className="list-group-item border-0 bg-light text-center"><b>{postTitle}</b></li>
                            </ul>
                        </li>
                        { /* Title - End */}
                        ...
                        <li className="list-group-item pl-0 bg-light">
                            <ul className="list-group list-group-horizontal">
                                <li className="list-group-item list-group-item-dark border-0 rounded pr-3" style={{ width: "110px" }}>
                                    <small><i className="fa fa-newspaper-o"></i> Writer </small>
                                </li>
                        ...
                        <li className="list-group-item pl-0 bg-light">
                            <ul className="list-group list-group-horizontal">
                                <li className="list-group-item list-group-item-secondary border-0 rounded pr-3" style={{ width: "110px" }}>
                        ...
                        <li className="list-group-item pl-0 bg-light">
                            <ul className="list-group list-group-horizontal">
                                ...
                                <li className="list-group-item border-0 bg-light"><b>{postSection}</b></li>
                            </ul>
                        </li>
                        { /* Post Section - End */}
