...
export default function Navigation() {
    ...
    return (
        <>
            {/* Nav - Start */ }
            <nav id="Navigation" className="navbar navbar-expand-lg bg-dark shadow-sm">

                { /* Brand - Start */}
                <Link className="navbar-brand text-white p-0" to="/">Breakday</Link>
                { /* Brand - End */}
    ...
    return (
        <> 
            <li className="nav-item">
                <Link className="nav-link text-white" to={`/filter/world`}>World</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link text-white" to={`/filter/politics`}>Politics</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link text-white" to={`/filter/business`}>Business</Link>
            </li> 
            <li className="nav-item">
                <Link className="nav-link text-white" to={`/filter/style`}>Style</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link text-white" to={`/filter/travel`}>Travel</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link text-white" to={`/filter/sport`}>Sports</Link>
            </li> 
        </>
        );
}
